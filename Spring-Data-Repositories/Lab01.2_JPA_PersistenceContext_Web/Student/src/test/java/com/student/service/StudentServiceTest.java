...
public class StudentServiceTest {
    ...
    @Test
    void testService_getStudentsByDepartment(){
        Collection<Student> chemistryStudents = service.getStudentsByDepartment("Chemistry");
        chemistryStudents.forEach(student -> {
            String studentPrinted = String.format("%-10d %-10s %-10s %-10s", student.getId(),student.getFirstName(), student.getSurname(), student.getDept());
            System.out.println(studentPrinted);
        });
    }

    @Test
    void testService_getStudentsByDepartment2(){
        Collection<Student> physicsStudents = service.getStudentsByDepartment2("Physics");
