...
public class StudentController {
    ...
    public ResponseEntity<Student> getSingleStudent(@RequestParam("id") Optional<Long> optionalLong) {
        return ResponseEntity.ok(studentService.get(optionalLong.orElse(1L)));
    }
